...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>프로필 정보 입력 &mdash; BaedalMate</title>
		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					<div class="row">
						<div id="top-title" class="col-12 display-6 my-3"><a href="signUp"><i class='bx bx-arrow-back'></i></a> 프로필 정보 입력</div>
					</div>
				</div>
			</div>
		</header>
			...
			<section class="pt-5">
				<div class="container">
					<div class="text-center pt-5">
						<form name="frmInsertProfile" method="post">
							<img src="images/profile-user.png" class="mb-3" id="profilePhoto" style="width:90px; height:90px;cursor:pointer;">
							<input type="file" id="btnInsertPhoto" style="display:none;">
							
							<div class="input-field mb-3">
								<p class="mb-1" style="text-align:left;">닉네임</p>
								<input type="text" class="form-control" id="nickname"/>
							</div>
							
						  <p class="mb-1" style="text-align:left;">성별</p>
							...
							<div class="input-field mb-5">
								<p class="mb-1" style="text-align:left;">연령대</p>
							...
							<button id="btnSignUp"class="btn btn-primary btn-block mb-3">가입 완료</button>
						</form>
					</div>
				</div>
			</section>
